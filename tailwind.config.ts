...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        "hero-pattern": "url('/placeholder.svg?height=1080&width=1920&text=Cultural+Festival+Background')",
        "cultural-pattern": "url('/placeholder.svg?height=800&width=1600&text=Tamil+Cultural+Pattern')",
        "stage-lights": "url('/placeholder.svg?height=600&width=1200&text=Stage+Lights+Background')",
        "traditional-art": "url('/placeholder.svg?height=800&width=1600&text=Traditional+Tamil+Art')",
      },
    },
  },
